...
const absoluteTemLowest = '-273.15°C'

console.log(absoluteTemLowest)
...
let numUserComments = '12'

console.log(numUserComments)
...
let toggleBtnIn = true

console.log(toggleBtnIn)
